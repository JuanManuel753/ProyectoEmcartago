...
{
    public class RepositorioPEDSYP : IRepositorioPEDSYP
    {
        private readonly HttpClient _httpClient;
        private readonly HttpClient _http;
        private readonly NavigationManager _navigationManager;

        public RepositorioPEDSYP(HttpClient httpClient, HttpClient http, NavigationManager navigationManager)
        {
        ...
        public List<PEDSYP> Funcionarios { get; set; } = new List<PEDSYP>();
